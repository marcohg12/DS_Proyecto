...
exports.confirmOrder = exports.setOrderState = exports.getUserOrders = exports.getOrder = exports.getOrders = void 0;
...
function getOrders() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderDAO.getOrders()];
...
function getOrder(orderId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderDAO.getDetail(orderId)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function getUserOrders(userId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderDAO.getOrdersUser(userId)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function setOrderState(orderId, state) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderDAO.changeOrderState(orderId, state)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    productDAO.updateProduct(productLines[i]._id, product.name, product.description, product.units - productLines[i].units, product.price);
                    _a.label = 4;
                case 4:
                    i++;
                    return [3 /*break*/, 2];
