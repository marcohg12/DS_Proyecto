    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            publicationS_1.default.findOne({ _id: id_publication }),
          ];
        case 1:
...
function getPublications() {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, publicationS_1.default.find()];
        case 1:
          return [2 /*return*/, _a.sent()];
      }
    });
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            publicationS_1.default.find({ category: id_category }),
          ];
        case 1:
          return [2 /*return*/, _a.sent()];
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            publicationS_1.default.find({ tags: { $in: tags } }),
          ];
        case 1:
          return [2 /*return*/, _a.sent()];
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            publicationS_1.default.updateOne(
              { _id: id_publication },
              {
                category: category,
                date: date,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            publicationS_1.default.deleteOne({ _id: id_publication }),
          ];
        case 1:
          return [2 /*return*/, _a.sent()];
      }
